...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "9000coin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"bitcoinbetalen.nl", "217.123.192.24"},
    {"answerlinux.com", "149.202.58.184"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"9000cointools.com", "testnet-seed.9000cointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. 9000coin is probably already running."), addrBind.ToString().c_str());
        else
