...
#if defined(NDEBUG)
# error "9000coin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x5555de9093d157e24600c7015d74ee69f6fed6c646c4c8d8071010a36a1c91ca");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // 9000coin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "9000coin Signed Message:\n";
...
{
    // 9000coin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 450050); // 9000coin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 60 * 60; // 9000coin: 1 hour days
static const int64 nTargetSpacing = 2.5 * 60; // 9000coin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // 9000coin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // 9000coin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x5555de9093d157e24600c7015d74ee69f6fed6c646c4c8d8071010a36a1c91ca");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "17/07/2016 AP: 3 officers dead, 3 hurt in Baton Rouge shooting";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 0.01 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("aabb4710fa689ad5023690c80f3a49c8f13f8d45b8c8aeeecbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1468775748;
        ...
        assert(block.hashMerkleRoot == uint256("0x2093ce96b3812f661856bcff37bf94bc3149886bcbec3f948a793933ee4484d8"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // 9000coin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("9000coinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("9000coinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("9000coinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("9000coin-miner");
    ...
    try { loop {
        ...
        printf("Running 9000coinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("9000coinMiner terminated\n");
        throw;
    }
}
